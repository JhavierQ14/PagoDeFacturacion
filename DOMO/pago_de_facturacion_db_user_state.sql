...
CREATE TABLE `user_state` (
  ...
  `user_state_name` varchar(64) NOT NULL,
  PRIMARY KEY (`id_user_state`),
  UNIQUE KEY `user_state_name_UNIQUE` (`user_state_name`)
...
INSERT INTO `user_state` VALUES (1,'activo');
...
-- Dump completed on 2022-05-31 18:13:54
