...
--
-- Table structure for table `tbl_tarjeta_bancaria`
--

DROP TABLE IF EXISTS `tbl_tarjeta_bancaria`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_tarjeta_bancaria` (
...
--
-- Dumping data for table `tbl_tarjeta_bancaria`
--

LOCK TABLES `tbl_tarjeta_bancaria` WRITE;
/*!40000 ALTER TABLE `tbl_tarjeta_bancaria` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_tarjeta_bancaria` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-01 11:00:15
